...
{  
    ...
    xy_0_.at<float>(0,0) = 0 - x;
    xy_0_.at<float>(0,1) = nrows - y;
    xy_0_.at<float>(0,2) = 1;

    xy_1_.at<float>(0,0) = ncols - x;
    xy_1_.at<float>(0,1) = nrows - y;
    xy_1_.at<float>(0,2) = 1;

    xy_2_.at<float>(0,0) = 0 - x;
    xy_2_.at<float>(0,1) = 0 - y;
    xy_2_.at<float>(0,2) = 1;

    xy_3_.at<float>(0,0) = ncols - x;
    xy_3_.at<float>(0,1) = 0 - y;
    ...
    //C.at<float>(2,0) = x;
    //C.at<float>(2,1) = y;
    //C.at<float>(2,0) = x + Cols - ncols ;
    //C.at<float>(2,1) = y - Rows + nrows;
    C.at<float>(2,0) = x  ;
    C.at<float>(2,1) = y;
